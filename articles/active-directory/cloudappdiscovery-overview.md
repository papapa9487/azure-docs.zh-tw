---
title: "Azure Active Directory 中的 Cloud App Discovery 改進功能 | Microsoft Docs"
...
## <a name="what-can-i-do-now-with-the-improvements-to-cloud-app-discovery-in-azure-ad"></a>我現在有如何處理 Azure AD 中的 Cloud App Discovery 改進功能？

* **更深入了解雲端應用程式使用量** Azure AD 中的 Cloud App Discovery 現在可探索所有組織網路流量和任何裝置中 **15,000 個以上的應用程式**。 
