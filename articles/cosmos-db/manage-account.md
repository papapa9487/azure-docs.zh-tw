...
在 [Azure 入口網站](https://portal.azure.com/)中，從 [Azure Cosmos DB 帳戶] 頁面上的資源功能表存取 [金鑰] 頁面，以檢視、複製及重新產生用來存取 Azure Cosmos DB 帳戶的存取金鑰。
...
3. 在 [Azure Cosmos DB 帳戶] 頁面中，按一下 [金鑰]。
4. 在 [金鑰] 頁面中，按一下 [重新產生] 按鈕，然後按一下 [確定] 以確認要產生新的金鑰。
