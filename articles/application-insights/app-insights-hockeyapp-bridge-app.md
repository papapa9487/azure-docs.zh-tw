...
> [!NOTE]
> Visual Studio Mobile Center 現在是 Microsoft 中用來監視最新行動應用程式的建議服務。 [了解如何使用 Mobile Center 和 Application Insights 設定您的應用程式](app-insights-mobile-center-quickstart.md)。
> 
> 
