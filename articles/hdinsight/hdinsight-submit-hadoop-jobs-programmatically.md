...
- **url**:
  ...
  - [使用 Curl 以 HDInsight 中的 Hadoop 執行 Hive 查詢](hdinsight-hadoop-use-hive-curl.md)
  - [使用 Curl 搭配執行 Pig 作業與 HDInsight 上的 Hadoop](hdinsight-hadoop-use-pig-curl.md)
  - [使用 Curl 搭配執行 Sqoop 作業與 HDInsight 上的 Hadoop](hdinsight-hadoop-use-sqoop-curl.md)
...
- **PowerShell**:
  ...
  - [使用 PowerShell 執行 Pig 查詢](hdinsight-hadoop-use-pig-powershell.md)
