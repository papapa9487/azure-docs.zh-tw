...
3. 選取安全殼層 (SSH)。
    ...
    ![Azure 入口網站中的 HDInsight 窗格](./media/hdinsight-spark-shell/hdinsight-spark-blade.png)

4. 複製顯示的 SSH 命令，並在您的終端機中執行該命令。

    ![Azure 入口網站中的 HDInsight SSH 窗格](./media/hdinsight-spark-shell/hdinsight-spark-ssh-blade.png)
