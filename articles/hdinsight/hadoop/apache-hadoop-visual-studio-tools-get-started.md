...
* Azure HDInsight 叢集︰若要建立叢集，請參閱[開始使用以 Linux 為基礎的 HDInsight](apache-hadoop-linux-tutorial-get-started.md)
* 已安裝下列軟體的工作站：
