...
1. 建立 Log Analytics 工作區。 如需詳細資訊，請參閱[開始使用 Log Analytics 工作區](../log-analytics/log-analytics-get-started.md)文件。

2. 在 HDInsight 叢集上建立 Kafka。 如需詳細資訊，請參閱[開始使用 HDInsight 上的 Apache Kafka](hdinsight-apache-kafka-get-started.md) 文件。
 ...
 * [ HDInsight 叢集之間製作 Kafka 的鏡像](hdinsight-apache-kafka-mirroring.md)
 * [在 HDInsight 上增加 Kafka 的 延展性](hdinsight-apache-kafka-scalability.md)
