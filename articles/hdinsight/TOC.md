...
## [開始使用互動式查詢](hdinsight-hadoop-use-interactive-hive.md)
...
#### [以 Java 拓撲處理事件](https://azure.microsoft.com/resources/samples/hdinsight-java-storm-eventhub/)
...
## 使用互動式查詢
### [使用 Zeppelin 來執行 Hive 查詢](hdinsight-connect-hive-zeppelin.md)
## 開發
...
### [將 Power BI 連線到 Hadoop](hdinsight-connect-hive-power-bi.md)
...
#### [使用 Azure PowerShell 來執行](hdinsight-hadoop-use-sqoop-powershell.md)
