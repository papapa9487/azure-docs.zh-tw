...
* [使用 REST 以 HDInsight 中的 Hadoop 執行 Hive 查詢](hdinsight-hadoop-use-hive-curl.md)
* [使用 REST 搭配 HDInsight 上的 Hadoop 執行 MapReduce 作業](hdinsight-hadoop-use-mapreduce-curl.md)
