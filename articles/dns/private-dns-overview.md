...
* **熟悉的工具和使用者體驗。** 為了縮短學習曲線，這個新供應項目使用已經妥善建立的 Azure DNS 工具 (PowerShell、Resource Manager 範本、REST API)，並且將會儘快在 CLI 和入口網站新增支援。
...
私人 DNS 區域在受管理的預覽版期間為免費。 公告正式運作版時，此功能將與現有的 Azure DNS 供應項目類似，採用依使用量計價的模型。 
