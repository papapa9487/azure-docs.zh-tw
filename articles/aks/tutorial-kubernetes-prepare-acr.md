...
使用 [az acr login](https://docs.microsoft.com/en-us/cli/azure/acr#az_acr_login) 命令登入 ACR 執行個體。 您必須在建立容器登錄時，為容器登錄提供唯一名稱。
...
> [部署 Kubernetes 叢集](./tutorial-kubernetes-deploy-cluster.md)