...
## <a name="troubleshooting-sync"></a>同步處理疑難排解
...
## <a name="troubleshooting-the-client-agent"></a>用戶端代理程式疑難排解
...
-   在與同步處理群組相同的資料中心中建立新的代理程式。 然後使用該代理程式註冊資料庫。
...
## <a name="troubleshooting-setup-and-maintenance"></a>設定和維護疑難排解
...
如果您從備份還原遺失或損毀的資料庫，資料庫所屬的同步處理群組中可能有無法聚合的資料。
