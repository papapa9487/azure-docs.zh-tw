...
若要在 Azure 入口網站中變更虛擬機器擴展集中的 VM 數目，在 VM 擴展集屬性區段中，按一下 [擴充] 刀鋒視窗上並使用滑動軸。 如需變更執行個體數目的做法，請參閱[變更虛擬機器擴展集的執行個體計數](https://msftstack.wordpress.com/2016/05/13/change-the-instance-count-of-an-azure-vm-scale-set/)。
...
注意：如果您的擴展集 _upgradePolicy_ 設為 Manual，您必須透過呼叫升級，將擴充功能套用至集合中的所有 VM。 在 CLI 中，這會是 _az vmss update-instances_。
