...
如前所述，有三層供您選擇：**開發人員**、**標準**和**進階**。 **開發人員**層應該用來評估服務，不適用於生產環境。 **開發人員**層沒有 SLA，您無法調整此階層的規模 (新增/移除單位)。 
...
您可以升級到任何階層，也能從任何階層降級。 請注意，升級或降級可以移除某些功能 - 例如，從進階層降級到標準層時，就會移除 VNET 或多區域部署。
