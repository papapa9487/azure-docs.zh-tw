...
<div class="content">
    ...
    <img src="media/cloudfoundry.png" align="right" alt="Cloud Foundry Logo"> Cloud Foundry 是開放原始碼的平台即服務 (PaaS)，可用於建置、部署和操作以各種不同語言和架構開發的 12-factor 應用程式。  了解如何透過我們的快速入門及教學課程，使用 Azure 上的 Cloud Foundry。
        </div>
    </div>
<h2>5 分鐘快速入門</h2>
