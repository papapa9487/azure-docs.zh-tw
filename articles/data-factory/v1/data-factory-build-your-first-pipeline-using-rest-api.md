...
> [!NOTE]
> 本文適用於正式推出 (GA) 的第 1 版 Data Factory。 如果您使用處於預覽狀態的 Data Factory 服務第 2 版，請參閱 [快速入門：使用 Azure Data Factory 第 2 版建立資料處理站](../quickstart-create-data-factory-rest-api.md)。
