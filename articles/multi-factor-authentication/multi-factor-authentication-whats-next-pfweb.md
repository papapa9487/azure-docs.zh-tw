...
>[!NOTE]
>這些設定在 Azure 入口網站是公開預覽。 如需如何在預覽版中管理 Azure Multi-Factor Authentication 設定的文件，請參閱[設定 Azure Multi-Factor Authentication 設定 - 公開預覽](multi-factor-authentication-whats-next.md)。
