...
所幸，我們可以使用 [Azure Machine Learning 重新訓練 API](retrain-models-programmatically.md)，並利用 [Azure Machine Learning PowerShell](powershell-module.md) 將工作自動化，以完成這項工作。
