...
| 負載平衡器 (內部和網際網路面向、基本和標準) |100 |1000 |
| 每一負載平衡器的負載平衡器 (基本) 規則 |150 |250 |
| 每一負載平衡器的負載平衡器 (標準) 規則 | 1250 | 1500|
| 每個 IP 組態的負載平衡器 (基本) 規則 |250 |250 |
| 每個負載平衡器 (基本) 的公用前端 IP |10 |30 |
| 每個負載平衡器 (標準) 的公用前端 IP | 10 | 600 |
| 每個負載平衡器 (基本) 的私人前端 IP |10 |連絡支援人員 |
| 每個負載平衡器 (標準) 的私人前端 IP | 10 | 600 |
