...
計算最佳化的 VM 大小，具有高 CPU 對記憶體比率，並且適用於中流量網頁伺服器、網路設備、批次處理及應用程式伺服器。 本文提供 vCPU 數量、資料磁碟和 NIC 的相關資訊，亦會介紹此群組中各種大小之儲存體輸送量和網路頻寬。
...
| 大小             | vCPU | 記憶體：GiB | 本機 SSD: GiB | 最大資料磁碟 | 最大快取和暫存儲存體輸送量︰IOPS / MBps (以 GiB 為單位的快取大小) | 最大 NIC/預期的網路頻寬 (Mbps) |
|------------------|--------|-------------|----------------|----------------|-----------------------------------------------------------------------|------------------------------------------------|
