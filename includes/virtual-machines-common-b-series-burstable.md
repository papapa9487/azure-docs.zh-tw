...
| 大小          | vCPU | 記憶體：GiB | 本機 SSD: GiB | VM 的基礎 CPU 效能 | VM 的最大 CPU 效能 | 點數累積 / 小時 | 最大累積點數 |
|---------------|--------|-------------|----------------|--------------------------------|---------------------------|-----------------------|--------------------|
...
## <a name="q--a-about-this-preview"></a>此預覽的相關問答集

### <a name="q-how-can-i-participate-in-this-preview"></a>問：如何參與這個預覽？
**答**：在其中一個支援區域要求 B 系列的配額。  在您的配額核准之後，您就可以使用入口網站或 API 來正常進行部署。 如需詳細資訊，請參閱 [Resource Manager 核心配額增加要求](../articles/azure-supportability/resource-manager-core-quotas-request.md)。
...
### <a name="q-is-there-a-discount-on-price-during-the-preview"></a>問：在預覽期間是否有折扣價格？
**答**：是的，您可以在我們的[定價頁面](http://aka.ms/vmsizes)檢視預覽價格。
...
### <a name="q-which-regions-can-i-access-the-preview-from"></a>問：我可以從哪些區域存取預覽？
**答**：B 系列將在以下區域內提供預覽：
- 美國- 西部 2
- 美國 - 東部
- 歐洲 - 西部
